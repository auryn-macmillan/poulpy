...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let config = InferenceConfig {
        ...
        fhe_silu_log_msg_mod: Some(10), // 1024-level LUT for SiLU
        fhe_identity_log_msg_mod: Some(10), // 1024-level LUT for identity refresh
    ...
    // Prompt we want to generate from (English)
