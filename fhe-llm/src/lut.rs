...
//! FHE_LLM can evaluate arbitrary fixed-precision nonlinearities by encoding
...
pub fn lut_eval_cost(params: &FHE_LLMParams, _lut: &NonlinearLUT) -> usize {
...
pub fn lut_eval_total_cost(params: &FHE_LLMParams, lut: &NonlinearLUT, num_slots: usize) -> usize {
...
mod tests {
    ...
    fn test_lut_cost_estimate() {
        let params = crate::params::FHE_LLMParams::new(crate::params::SecurityLevel::Bits80, crate::params::Precision::Int8);
        let lut = NonlinearLUT::gelu(8);
