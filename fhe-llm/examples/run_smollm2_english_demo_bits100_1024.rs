...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // High‑precision configuration (Bits100 security, FP16, 1024‑level LUTs, no frequent bootstrap)
    let config = InferenceConfig {
        ...
        // Use 1024‑level LUTs to reduce quantisation error (log_msg_mod=10)
