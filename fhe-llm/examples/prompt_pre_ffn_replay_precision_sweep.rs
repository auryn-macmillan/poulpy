...
fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let midrange_result = pipeline.sweep_prompt_first_layer_pre_ffn_replay_precisions_with_pre_ffn_config(
        &prompt,
        attn_decode,
        residual_decode,
        &precisions,
    ...
    let range32_result = pipeline.sweep_prompt_first_layer_pre_ffn_replay_precisions_with_pre_ffn_config(
        &prompt,
        attn_decode,
        residual_decode,
        &precisions,
