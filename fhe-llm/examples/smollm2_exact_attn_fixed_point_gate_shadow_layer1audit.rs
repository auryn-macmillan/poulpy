...
fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let result = pipeline.compare_prompt_exact_attn_fixed_point_gate_shadow_first_layer_sublayers_with_compression(
        &prompt,
        TRACE_PATH,
        fractional_bits,
        compress_bits,
    ...
    println!("fractional_bits: {}", fractional_bits);
    println!("compress_bits: {}", compress_bits);
