/// Plaintext-only prompt comparison (exact vs refreshed) at native dimensions.
///
/// Usage:
///   cargo run --release --example smollm2_prompt_plain [prompt] [d_model] [n_layers]
///   cargo run --release --example smollm2_prompt_plain --raw "2+2=" 576 1536 30
use std::process;
...
fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    eprintln!("=== SmolLM2 Plaintext Prompt Comparison ===");
