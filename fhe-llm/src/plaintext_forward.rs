...
//! |--------------------|-----------------|
//! | `dot_product` | `_FHE_LLM_dot_product` |
//! | `matvec` | `_FHE_LLM_dot_product` per row |
//! | `rms_norm` | `_FHE_LLM_rms_norm_vec` |
//! | `exact_softmax` | `_FHE_LLM_apply_softmax` |
//! | `exact_silu` | `apply_poly_activation` with SiLU poly |
//! | `exact_gelu` | `apply_poly_activation` with GELU poly |
//! | `ffn_swiglu` | `_FHE_LLM_ffn_swiglu_vec` |
//! | `ffn_standard` | `_FHE_LLM_ffn_standard_vec` |
//! | `single_head_attention` | `_FHE_LLM_single_head_attention` |
//! | `multi_head_attention` | `_FHE_LLM_multi_head_attention_vec` |
//! | `transformer_block` | `_FHE_LLM_transformer_block_vec` |
//! | `forward_pass` | `_FHE_LLM_forward_pass_vec` |
...
///
/// Mirrors `_FHE_LLM_apply_rope_vec` but in f64 domain.
///
...
///
/// Mirrors `_FHE_LLM_multi_head_attention_vec`:
